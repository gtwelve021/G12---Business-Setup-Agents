...
function usage() {
  console.log('Usage: node scripts/generate-secret.js [--save] [--env-file path] [--clip]');
  console.log('  --save        Append G12_LEAD_SECRET to the env file (default: chatgpt-app-g12/.env)');
  console.log('  --env-file    Path to env file to write (used with --save)');
  console.log('  --clip        Copy secret to clipboard (pbcopy on macOS, clip on Windows)');
}
